...
export const experiences: ExperienceItem[] = [
  {
    ...
    startDate: '2024-11',
    endDate: '2025-10',
    description: 'Full-stack development & DevOps role focusing on ETL pipelines, cloud infrastructure, and analytics tools. Built comprehensive Azure-based solutions including Kubernetes clusters.',
    technologies: ['Python', 'React', 'Azure', 'Kubernetes', 'Docker', 'TimescaleDB'],
    achievements: [
  ...
  },
  {
    ...
    startDate: '2022-11',
    endDate: '2024-11',
    description: 'Full-stack development role focusing on energy trading systems and data processing. Developed ETL processes, trading platform integrations, and Excel add-ins for traders to efficiently execute trades through multiple APIs.',
    technologies: ['C#', 'React', 'Azure Functions', 'EF Core', 'MSSQL', 'Python', 'REST APIs', 'SOAP APIs'],
    achievements: [
  ...
  },
  {
    ...
    startDate: '2025-01',
    endDate: '2025-06',
    description: 'Research project on predicting mRNA expression levels using deep learning techniques. Evaluated sequence-based models, designed CNNs and Graph Neural Networks, and created replicable data pipelines for biological data processing. Achieved grade 12.',
    technologies: ['PyTorch', 'Python', 'Deep Learning', 'Bioinformatics', 'Graph Neural Networks', 'Transformers'],
    achievements: [
  ...
  },
  {
    ...
    startDate: '2023-01',
    endDate: '2023-06',
    description: 'Research on optimizing shortest path computations using OpenStreetMap data. Implemented and compared multiple algorithms including Dijkstra, A*, ALT with various enhancements. Created interactive visualization system for real-time algorithm demonstration across Europe. Achieved grade 10.',
    technologies: ['Python', 'Java', 'PostgreSQL', 'PostGIS', 'React', 'Algorithm Optimization'],
    achievements: [
