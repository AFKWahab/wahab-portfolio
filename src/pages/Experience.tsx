...
import { Box, Typography, Container, Button, Card, CardContent, Chip, List, ListItem, ListItemText } from '@mui/material';
import { ArrowBack as ArrowBackIcon, Work as WorkIcon, School as SchoolIcon } from '@mui/icons-material';
...
const Experience: React.FC = () => {
  ...
  const getIcon = (position: string) => {
    return position.includes('MSc') || position.includes('BSc') ? <SchoolIcon /> : <WorkIcon />;
  };
              ...
              <Box sx={{ display: 'flex', alignItems: 'flex-start', gap: 2, mb: 3 }}>
                ...
                <Box sx={{ flex: 1 }}>
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 2 }}>
                    ...
                    >
                      {formatDate(selectedExperience.startDate)} - {selectedExperience.endDate ? formatDate(selectedExperience.endDate) : 'Present'}
                    </Typography>
                    <Chip
                      label={getDuration(selectedExperience.startDate, selectedExperience.endDate)}
                      size="small"
                      sx={{
                ...
                {experiences.map((exp) => (
                  <Card
                    ...
                    sx={{
                      ...
                      border: selectedExperience.id === exp.id
